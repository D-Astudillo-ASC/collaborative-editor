...
>(({ className, children, ...props }, ref) => {
  // Extract text from children for SelectValue to read
  const extractText = (node: React.ReactNode): string => {
    ...
    if (React.isValidElement(node)) {
      ...
      if (nodeProps.children) {
        return React.Children.toArray(nodeProps.children).map(extractText).filter(Boolean).join(' ');
        }
    }
  ...
  return (
    ...
    >
      ...
      {/* ItemText is required for SelectValue, wrap it in a hidden container */}
